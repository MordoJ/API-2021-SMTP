...
public class ConfigurationManager implements IConfigurationManager {
    ...
    public ConfigurationManager() throws IOException {
        victims  = loadAddressFromFile("src/main/java/config/victims.utf8");
        messages = loadMessagesFromFile("src/main/java/config/messages.utf8");
        loadProperties("src/main/java/config/config.properties");
    }
